...
import com.vaibhav.news.Exception.NewsNotFoundException;
...
public class NewsServiceImp implements NewsService {
    ...
    public News getNewsById(String id) {
        if (id != null) {
            return newsRepository.findById(id).orElseThrow(() -> new NewsNotFoundException("News item with id " + id + " not found"));
        } else {
